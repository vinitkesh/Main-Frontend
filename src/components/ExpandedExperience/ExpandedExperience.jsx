import style from "./ExpandedExperience.module.css";
...
export const ExpandedExperience = ({ name, stars,ctcNum, positionData, positionData2, image, companyImage }) => {
  return (
    <div className={style.ExpandedExperience}>
