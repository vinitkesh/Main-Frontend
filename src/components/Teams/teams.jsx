...
export default function GetToKnowOurTeam({ image, title, button }) {
    return (
            ...
            >
                ...
                <div className="mt-[87px] gap-4 flex justify-center items-center">
                    ...
                    <div className={styles.verticalTextBlock}>
                        <span className={styles.verticalText}>Present Team</span>
                    ...
                    <div className={styles.verticalTextBlock}>
                        <span className={styles.verticalText}>Alumni</span>
                        <button className={styles.circleButton}>
                            <Image
                                src="/Arrow 7.svg"
                                width={20}
