        ...
        <div className=' bg-[#292929] max-w-[110rem] mx-auto '>
            ...
            >
                <div className="mt-20 lg:mt-0">
                    <p className="bg-gradient-to-r from-blue-600 to-blue-300 bg-clip-text text-transparent font-geist text-4xl lg:text-6xl font-bold leading-79">Insights that Matters</p>
                    <div className="flex justify-center items-center mt-2 lg:mt-5">
                        ...
                        <Image className="hidden lg:block mx-3 " src="Group76.svg" width={130} height={26} alt="image"></Image>
                    </div>
                </div>
                <div>
                    <Image src="Desk.svg" width={575} height={428} alt="image"></Image>
                </div>
